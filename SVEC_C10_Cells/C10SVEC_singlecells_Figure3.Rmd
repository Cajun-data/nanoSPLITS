...
greater than 20 were removed. To accomplish dimensional reduction of proteomics data, values were imputed using DreamAI. For Figure 3c,  only proteins with less than 40% missingness in both SVEC and C10 were imputed and retained.  For Figure 3d, only proteins in C10 with less than 40% missingness were imputed and retained. 
