...
## Figure 2c
**Figure 2c. Coefficients of variation from RNAseq results**
```{r, echo = FALSE, fig.width= 6, fig.height = 7, message=FALSE, warning=FALSE, results='hide'}
main6+
...
## Figure 2c
**Figure 2c. Coefficients of variation for LFQ proteomics of 11, 3, and 1 C10 cells**
```{r,echo = FALSE, fig.width= 6, fig.height = 7, message=FALSE, warning=FALSE, results='hide'}
 main2 +
  stat_summary(fun.data=data_summary)
```
...
## Figure 2d
**Figure 2d. Distributions of the ratios of protein intensities between 11, 3, and 1 C10 cell**
```{r,echo = FALSE, fig.width= 6, fig.height = 7, message=FALSE, warning=FALSE, results='hide'}
main3
```

## Figure 2e (and associated code)
**Figure 2e: Pearson Correlation heatmap of RNAseq (TPM) and proteomics (riBAQ) data**
...
## Figure 2b (and associated code)
**Figure 2b. Pie chart of the localization of all genes/proteins found in the scRNAseq and scProteomic data **
